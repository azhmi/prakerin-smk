                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="@yield('status-beranda')">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Info Magang" href="/"><span class="mini-sub-pro">Info Magang</span></a></li>   
                                @if (Route::has('login'))
                        @if (Auth::check())
                        @if(Auth::user()->level=="admin") 
                                <li><a title="Kelola Magang" href="/bukti-pembayaran/verifikasi"><span class="mini-sub-pro">verifikasi  berkas</span></a></li>
                                <li><a title="Kelola Magang" href="/magang"><span class="mini-sub-pro">Kelola Magang</span></a></li>
                        ...
                        <li><a title="Magang Saya" href="/siswa/magang/saya"><span class="mini-sub-pro">Magang Saya</span></a></li>
                        ...
                        <li><a title="Magang Saya" href="/pembimbing/mysiswa"><span class="mini-sub-pro">Siswa Saya</span></a></li>
                        ...
                        <li class="@yield('pembimbing')">
                            <a class="has-arrow" href="/pembimbing" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap"></span> <span class="mini-click-non">Pembimbing</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Professors" href="/pembimbing"><span class="mini-sub-pro">All Pembimbing</span></a></li>
                                <li><a title="Add Professor" href="/pembimbing/add"><span class="mini-sub-pro">Add Pembimbing</span></a></li>
                            </ul>
                        </li>
                        <li class="@yield('siswa')">
                            <a class="has-arrow" href="/siswa" aria-expanded="false"><span class="educate-icon educate-student icon-wrap"></span> <span class="mini-click-non">Siswa</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Students" href="/siswa"><span class="mini-sub-pro">Data siswa</span></a></li>
                                <li><a title="Add Students" href="/siswa/add"><span class="mini-sub-pro">Add Student</span></a></li>
                            </ul>
                        </li>
                        <li class="@yield('tempat')">
                            <a class="has-arrow" href="/tempat-magang" aria-expanded="false"><span class="educate-icon educate-course icon-wrap"></span> <span class="mini-click-non">Tempat Magang</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Courses" href="/tempat-magang"><span class="mini-sub-pro">All Tempat</span></a></li>
                                <li><a title="Add Courses" href="/tempat-magang/add"><span class="mini-sub-pro">Add Tempat</span></a></li>
                            </ul>
                        </li> 
                        @endif @endif @endif                       
                    </ul>
