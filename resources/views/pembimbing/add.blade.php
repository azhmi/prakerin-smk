                        ...
                        @csrf
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <div class="form-group">
                                                        <input name="pbnip" type="number" class="form-control" placeholder="NIP" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <input name="pbtemla" type="text" class="form-control" placeholder="tempat lahir" required>
                                                    </div>
                                                   
                                                    <div class="form-group">
                                                        <input name="pbtangla" type="date" class="form-control" placeholder="tangla" required>
                                                    </div>
